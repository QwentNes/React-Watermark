    ...
    return (
        <Modal show={true}>
            <HeaderBlock>
                ...
                <Prefix>Спасибо за использование</Prefix>
            </HeaderBlock>
            <Content>
                <div className={style.list}>
                    <div className={style.item_download}>
                        ...
                        <div className={style.doc_info}>
                            <div className={style.name}>image_watermark.png</div>
                            <div className={style.size}>5.2MB</div>
                        </div>
                    </div>
                </div>
            </Content>
